...
public class RegcrowCustomerServiceTest {
    ...
    @BeforeEach public void setUp() throws CustomerRegistrationFailedException {
    ...
    @Test public void getCustomerByIdTest() throws CustomerRegistrationFailedException, UserNotFoundException {
    ...
    @Test public void updateCustomerTest() throws UserNotFoundException, ProfileUpdateFailedException {
        ...
        assertThat(foundCustomer.getName().contains("Folahan") && foundCustomer.getName().contains("Doe")).isFalse();
        ...
        assertThat(customerResponse.getName().contains("Folahan") && customerResponse.getName().contains("Doe")).isTrue();
    }
